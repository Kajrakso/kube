...
void bench_moves();
void bench_moves_and_index_calculation();
void bench_moves_and_3_lookups_normal();
void bench_moves_and_6_lookups_normal_and_inverse();
void bench_moves_and_6_lookups_normal_and_inverse_new();
...
void bench() {
    ...
    bench_moves();
    bench_moves();
    bench_moves_and_index_calculation();
    bench_moves_and_index_calculation();
    bench_moves_and_index_calculation();
    bench_moves_and_3_lookups_normal();
    bench_moves_and_3_lookups_normal();
    bench_moves_and_3_lookups_normal();
    bench_moves_and_6_lookups_normal_and_inverse();
    bench_moves_and_6_lookups_normal_and_inverse();
    bench_moves_and_6_lookups_normal_and_inverse();
    bench_moves_and_6_lookups_normal_and_inverse_new();
    bench_moves_and_6_lookups_normal_and_inverse_new();
    bench_moves_and_6_lookups_normal_and_inverse_new();
