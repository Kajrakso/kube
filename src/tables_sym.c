            ...
            for (int co_fb = 0; co_fb < 3; co_fb++) {
              for (int co_lr = 0; co_lr < 3; co_lr++) {
                for (int co_ud = 0; co_ud < 3; co_ud++) {
                  ...
                  sym_table_corner_transformation[24 * x4 + 12 * x3 + 4 * x2 +
                                                  x1][old_c] = new_c;
                }
              }
            }
                            ...
                            for (int O10 = 0; O10 < 2; O10++) {
                              for (int O11 = 0; O11 < 2; O11++) {
                                for (int k = 0; k < 16; k++) {
                                  ...
                                  update_edge_orien(
                                      &cube.edges[which_edge_at_pos(UB, &cube)],
                                      O1, 0, 0);
                                  update_edge_orien(
                                      &cube.edges[which_edge_at_pos(UR, &cube)],
                                      O2, 0, 0);
                                  update_edge_orien(
                                      &cube.edges[which_edge_at_pos(UF, &cube)],
                                      O3, 0, 0);
                                  update_edge_orien(
                                      &cube.edges[which_edge_at_pos(UL, &cube)],
                                      O4, 0, 0);
                                  update_edge_orien(
                                      &cube.edges[which_edge_at_pos(DF, &cube)],
                                      O5, 0, 0);
                                  update_edge_orien(
                                      &cube.edges[which_edge_at_pos(DR, &cube)],
                                      O6, 0, 0);
                                  update_edge_orien(
                                      &cube.edges[which_edge_at_pos(DB, &cube)],
                                      O7, 0, 0);
                                  update_edge_orien(
                                      &cube.edges[which_edge_at_pos(DL, &cube)],
                                      O8, 0, 0);
                                  update_edge_orien(
                                      &cube.edges[which_edge_at_pos(BL, &cube)],
                                      O9, 0, 0);
                                  update_edge_orien(
                                      &cube.edges[which_edge_at_pos(BR, &cube)],
                                      O10, 0, 0);
                                  update_edge_orien(
                                      &cube.edges[which_edge_at_pos(FR, &cube)],
                                      O11, 0, 0);
                                  update_edge_orien(
                                      &cube.edges[which_edge_at_pos(FL, &cube)],
  ...
  for (uint64_t c_index = 0; c_index < NCCU * NCO; c_index++) {
    ...
    if (cclass_table[best].cclass == -1) {
      ...
      cclass_table[c_index] = (struct c_index_cclass_sym){
          .cclass_i = cclass_num, .cclass = best, .sym = sym};
    } else {
      cclass_table[c_index] = (struct c_index_cclass_sym){
